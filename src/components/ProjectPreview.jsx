        ...
        <>
            <div className="mt-4 md:mt-8">
                ...
                <div className="text-slate-100 bg-slate-800 rounded-lg p-2 md:p-4">
                    ...
                    {!(project.url === "") && (
                        <>
                            ## Website is Live : [{project.url}]({project.url}){" "}
                            <br /> <br />
                        </>
                    )}
                    {!(
                        ...
                        <>
                            ...
                            {!(project.screenshots.sc1 === "") && (
                                <>
                                    ![screenshot]({project.screenshots.sc1}){" "}
                                    <br />
                                </>
                            )}
                            {!(project.screenshots.sc2 === "") && (
                                <>
                                    ![screenshot]({project.screenshots.sc2}){" "}
                                    <br />
                                </>
                            )}
                            {!(project.screenshots.sc3 === "") && (
                                <>
                                    ![screenshot]({project.screenshots.sc3}){" "}
                                    <br />
                                </>
                            )}
                        </>
